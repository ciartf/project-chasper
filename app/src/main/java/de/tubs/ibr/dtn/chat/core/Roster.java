...
public class Roster {
	...
	public long updatePresence(String buddyId, Date created, String presence, String nickname, String status, String voiceeid, String language, String country, Long flags)
	{
